...
const Login = () => {
  ...
  return (
    <section className="px-3 lg:px-0 bg-[url('./assets/images/mask.png')] bg-cover bg-no-repeat">
      <div className="w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10 bg-white">
        <h3 className="text-headingColor text-[22px] leading-9 font-bold mb-1 p-3">
